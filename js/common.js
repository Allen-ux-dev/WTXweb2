// 翻译字典
        const translations = {
            'zh': {
                ...
                'projects': '作品项目',
                'worksKicker': 'Works',
                'worksIntro': '这里展示我做过的实用项目，可以在线查看教程，也可以直接下载文件。',
                'workTypeTool': '功能工具',
                'workTypeShortcut': 'macOS 快捷指令',
                'cardSimulatorProject': '抽卡概率模拟器',
                'cardSimulatorProjectDesc': '一个用于模拟抽卡概率的互动网页，可以设置抽卡次数、概率和保底规则，直观看到结果分布。',
                'quickNewFileProject': '快速新建文件',
                'quickNewFileProjectDesc': '一个放进 macOS 快捷指令的 zsh 脚本，可以从 Finder 右键或菜单栏快速创建常用文件和文件夹。',
                'viewDetails': '查看详情',
                'viewTutorial': '查看教程',
                'downloadProject': '下载',
                'about': '关于我',
            ...
            'en': {
                ...
                'projects': 'Works',
                'worksKicker': 'Works',
                'worksIntro': 'A small collection of practical projects, with online guides and direct downloads.',
                'workTypeTool': 'Tool',
                'workTypeShortcut': 'macOS Shortcut',
                'cardSimulatorProject': 'Card Probability Simulator',
                'cardSimulatorProjectDesc': 'An interactive web page for simulating card draw probability, with configurable draw counts, rates, and pity rules.',
                'quickNewFileProject': 'Quick New File',
                'quickNewFileProjectDesc': 'A zsh script for macOS Shortcuts that creates common files and folders quickly from Finder or the menu bar.',
                'viewDetails': 'View Details',
                'viewTutorial': 'View Guide',
            ...
            'fr': {
                ...
                'worksKicker': 'Works',
                'worksIntro': 'Une petite collection de projets pratiques, avec guides en ligne et téléchargements directs.',
                'workTypeTool': 'Outil',
                'workTypeShortcut': 'Raccourci macOS',
                'cardSimulatorProject': 'Simulateur de probabilité de tirage',
                'cardSimulatorProjectDesc': 'Une page interactive pour simuler les probabilités de tirage, avec nombre de tirages, taux et règles de garantie configurables.',
                'quickNewFileProject': 'Créer rapidement un fichier',
                'quickNewFileProjectDesc': 'Un script zsh pour Raccourcis macOS qui crée rapidement des fichiers et dossiers courants depuis Finder ou la barre de menus.',
                'viewDetails': 'Voir les détails',
                'viewTutorial': 'Voir le guide',
                'downloadProject': 'Télécharger',
        ...
        function generatedTopChrome(activePage) {
            ...
            return `<div class="gradient-blinds-container" id="gradientBlindsBg"></div><div class="click-spark-container" id="clickSparkContainer"></div><nav><div class="container nav-container"><a href="index.html" class="logo">WTX</a><div class="nav-links"><a href="index.html" class="nav-link">首页</a><a href="history.html" class="nav-link${active('history')}">历史</a><a href="events.html" class="nav-link${active('events')}">事件</a><a href="index.html#skills" class="nav-link">专业技能</a><a href="index.html#projects" class="nav-link">作品项目</a><a href="index.html#about" class="nav-link">关于我</a><a href="index.html#contact" class="nav-link">联系方式</a><div class="user-status" id="userStatus"><div class="user-avatar" id="userAvatar" style="display: none;"></div><span class="user-name" id="userName" style="display: none;"></span><button class="login-btn" id="loginBtn">登录</button></div><div class="language-switcher" id="languageSwitcher"><span id="currentLanguage">中文</span><i class="fas fa-chevron-down"></i><div class="language-options" id="languageOptions"><div class="language-option" data-lang="zh">中文</div><div class="language-option" data-lang="en">English</div><div class="language-option" data-lang="fr">Français</div></div></div><button class="settings-btn" id="settingsBtn"><i class="fas fa-cog"></i></button></div><button class="mobile-menu-btn" id="mobileMenuBtn"><i class="fas fa-bars"></i></button></div></nav><div class="mobile-menu-overlay" id="mobileMenuOverlay"></div><div class="mobile-menu" id="mobileMenu"><button class="mobile-menu-close" id="mobileMenuClose"><i class="fas fa-times"></i></button><div class="mobile-menu-links"><a href="index.html" class="nav-link">首页</a><a href="history.html" class="nav-link${active('history')}">历史</a><a href="events.html" class="nav-link${active('events')}">事件</a><a href="index.html#skills" class="nav-link">专业技能</a><a href="index.html#projects" class="nav-link">作品项目</a><a href="index.html#about" class="nav-link">关于我</a><a href="index.html#contact" class="nav-link">联系方式</a><div class="user-status" id="mobileUserStatus"><div class="user-avatar" id="mobileUserAvatar" style="display: none;"></div><span class="user-name" id="mobileUserName" style="display: none;"></span><a href="#" class="mobile-login-btn" id="mobileLoginBtn">登录</a></div><div class="language-switcher" id="mobileLanguageSwitcher"><span id="mobileCurrentLanguage">中文</span><i class="fas fa-chevron-down"></i><div class="language-options" id="mobileLanguageOptions"><div class="language-option" data-lang="zh">中文</div><div class="language-option" data-lang="en">English</div><div class="language-option" data-lang="fr">Français</div></div></div><a href="#" id="mobileSettingsBtn"><i class="fas fa-cog"></i> 网站设置</a></div></div>`;
        }
